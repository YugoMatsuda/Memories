...
public struct AuthenticatedAPIClient: AuthenticatedAPIClientProtocol, Sendable {
    ...
    public func send(_ apiRequest: some APIRequestProtocol) async throws -> Data {
        ...
        do {
            ...
            print("AuthenticatedAPIClient.send request:", apiRequest, "error:", error)
            throw error
        }
    }
}
...
// MARK: - private
private extension AuthenticatedAPIClient {
